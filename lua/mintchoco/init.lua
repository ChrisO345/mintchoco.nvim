...
local utils = require("mintchoco.utils")
local theme = {}
...
local function set_groups(colorscheme)
  ...
  local groups = {
    ...
    Visual = {
      bg = utils.shade(colorscheme.syntaxFunction, 0.40, colorscheme.editorBackground),
    },
...
function theme.colorscheme()
  ...
  local colorscheme
  if bg == "light" then
    colorscheme = require("mintchoco.colors.light")
  else
    colorscheme = require("mintchoco.colors.dark")
  end
